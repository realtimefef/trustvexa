 ...
 */
export function computeServerAuthoritativeBreakdown(
  server: ServerMoneyInputs,
 ...
 * *(Requirement 17.5)*
 */
export function reconcileClientDisplay(
  authoritative: FeeBreakdown,
  clientDisplay: Partial<Record<keyof FeeBreakdown, bigint>>,
): ClientDisplayReconciliation {
  const comparable: readonly (keyof FeeBreakdown)[] = [
    'dealAmountCents',
    'platformFeeCents',
    'settlementFeeCents',
    'gasFeeCents',
