 ...
 */
export async function findDueFundingWindowDeals(nowIso: string): Promise<DueDeal[]> {
  const res = await query<DueDeal>(
...
export async function findDueCompletionClockDeals(nowIso: string): Promise<DueCompletionDeal[]> {
  const res = await query<DueCompletionDeal>(
    `SELECT id, seller_id FROM deals
      WHERE status = 'Funded'
        AND legal_hold = false
...
export async function findDueInspectionWindowDeals(nowIso: string): Promise<DueDeal[]> {
  const res = await query<DueDeal>(
    `SELECT id FROM deals
 ...
 */
export async function lowerUserTrust(userId: string): Promise<void> {
  await query(
    `UPDATE users
...
export async function raiseUserTrust(userId: string): Promise<void> {
  await query(
    `UPDATE users
...
export async function setFundingWindow(dealId: string, fundByIso: string): Promise<void> {
 ...
 */
export async function setCompletionClock(
  dealId: string,
...
export async function setInspectionWindow(
  dealId: string,
  inspectionUntilIso: string,
): Promise<void> {
