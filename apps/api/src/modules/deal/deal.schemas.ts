 ...
 */
export const COIN_NETWORK_SUPPORT: Readonly<Record<SupportedCoin, readonly SupportedNetwork[]>> = {
...
export function isCoinNetworkSupported(coin: SupportedCoin, network: SupportedNetwork): boolean {
