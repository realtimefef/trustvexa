...
function encodeDraft(data: DraftData): string {
  return JSON.stringify(data);
}

function decodeDraft(raw: string | null): DraftData {
  if (raw === null || raw === '') {
    return {};
  }
...
export async function saveDraft(userId: string, input: SaveDraftInput): Promise<DraftSummary> {
