...
export function dealRouter(): Router {
  ...
  router.post(
    '/drafts',
    ...apiChain({ schemas: { body: saveDraftSchema }, roles: [...ACCOUNT_ROLES] }),
    asyncHandler(controller.saveDraft),
  );
  router.get(
    '/drafts',
    ...apiChain({ roles: [...ACCOUNT_ROLES] }),
    asyncHandler(controller.listDrafts),
  );
  router.get(
    '/drafts/:id',
    ...apiChain({ schemas: { params: draftIdParamSchema }, roles: [...ACCOUNT_ROLES] }),
  ...
  router.post(
    ...
    rateLimiter({ windowSeconds: 60, max: 8, prefix: 'vc' }),
    asyncHandler(verificationController.submitCode),
  );
  ...
  router.get(
    '/:id/agreement',
    ...apiChain({ schemas: { params: dealIdParamSchema }, roles: [...ACCOUNT_ROLES] }),
    asyncHandler(termsController.getAgreement),
  );
  router.post(
    '/:id/terms/accept',
    ...apiChain({
  ...
  router.get(
    '/:id/amendments',
    ...apiChain({ schemas: { params: dealIdParamSchema }, roles: [...ACCOUNT_ROLES] }),
    asyncHandler(amendmentController.listAmendments),
  );
  router.post(
    '/:id/amendments/:amendmentId/decision',
    ...apiChain({
  ...
  router.get(
    '/:id/cancellations',
    ...apiChain({ schemas: { params: dealIdParamSchema }, roles: [...ACCOUNT_ROLES] }),
    asyncHandler(amendmentController.listCancellations),
  );
  router.post(
    '/:id/cancellations/:cancellationId/decision',
    ...apiChain({
  ...
  router.post(
    '/:id/cancellations/:cancellationId/middleman-decision',
    ...apiChain({
