...
export function hashInviteToken(token: string, key: Buffer | string): string {
 ...
 */
export function evaluateInvite(state: InviteState, now: Date = new Date()): InviteUsability {
