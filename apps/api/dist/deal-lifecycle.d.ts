 ...
 * start timer windows.
 */
export { runLifecycleTimers, startFundingWindow, startCompletionClock, startInspectionWindow, inspectionWindowHours, fundingWindowHours, COMPLETION_CLOCK_DAYS, } from './modules/deal/lifecycle-timer.service.js';
export type { LifecycleTimerSummary, RunLifecycleTimersArgs, } from './modules/deal/lifecycle-timer.service.js';
export { applyDealTransition } from './modules/deal/deal.service.js';
//# sourceMappingURL=deal-lifecycle.d.ts.map