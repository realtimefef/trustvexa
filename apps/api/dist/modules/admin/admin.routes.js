...
export function adminRouter() {
    ...
    router.post('/legal-holds', ...apiChain({
        schemas: { body: legalHoldBodySchema },
        roles: ['middleman'],
        enforceIdempotency: true,
    }), asyncHandler(extra.placeLegalHold));
    router.post('/legal-holds/:holdId/release', ...apiChain({
    ...
    router.post('/appeals/:appealId/decide', ...apiChain({
    ...
    router.patch('/aml-alerts/:alertId', ...apiChain({
    ...
    router.post('/break-glass', ...apiChain({
    ...
    router.post('/users/:userId/pii', ...apiChain({
    ...
    router.post('/withdrawal-allowlist', ...apiChain({
        schemas: { body: allowlistBodySchema },
        roles: ['middleman'],
        enforceIdempotency: true,
    }), asyncHandler(extra.addWithdrawalAllowlist));
    router.patch('/withdrawal-allowlist/:id', ...apiChain({
