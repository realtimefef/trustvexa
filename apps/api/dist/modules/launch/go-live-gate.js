...
export const REQUIRED_OPERATOR_INPUTS = [
 ...
 */
export function evaluateGoLive(provided) {
    const blockers = [];
...
export function realMoneyAllowed(status) {
    return status.ready;
}
//# sourceMappingURL=go-live-gate.js.map