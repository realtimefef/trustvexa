...
export function handoverRouter() {
    ...
    router.get('/deals/:id', ...apiChain({ schemas: { params: dealIdParamSchema }, roles: ['user', 'middleman'] }), asyncHandler(controller.getDealHandover));
    // POST /api/v1/handover/items/:itemId/reveal — middleman reveals to the buyer.
    router.post('/items/:itemId/reveal', ...apiChain({ schemas: { params: handoverItemParamSchema }, roles: ['middleman'] }), asyncHandler(controller.revealHandoverItem));
    ...
    router.post('/deals/:id/checklist', ...apiChain({
    ...
    router.post('/deals/:id/milestones/:milestoneId/release', ...apiChain({
...
//# sourceMappingURL=handover.routes.js.map