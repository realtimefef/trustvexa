...
export function profileRouter() {
    ...
    router.patch('/', ...apiChain({ schemas: { body: updateProfileSchema }, roles: ['user', 'middleman'] }), asyncHandler(controller.updateProfile));
    router.get('/preferences', ...apiChain({ roles: ['user', 'middleman'] }), asyncHandler(controller.getPreferences));
    router.patch('/preferences', ...apiChain({ schemas: { body: updatePreferencesSchema }, roles: ['user', 'middleman'] }), asyncHandler(controller.updatePreferences));
    router.delete('/sessions', ...apiChain({ roles: ['user', 'middleman'] }), asyncHandler(controller.revokeSessions));
    router.post('/avatar', ...apiChain({ roles: ['user', 'middleman'] }), asyncHandler(controller.uploadAvatar));
    router.post('/delete', ...apiChain({ schemas: { body: accountActionSchema }, roles: ['user', 'middleman'] }), asyncHandler(controller.deleteMe));
    return router;
}
