...
export async function getMyTrust(req, res) {
...
export async function submitPublicReview(req, res) {
...
export async function listPublicReviewsForModeration(req, res) {
    requireUserId(req);
    const result = await publicReviews.listPublicReviewsForModeration();
    res.status(200).json(result);
}
/** Middleman: edit a public review's content. */
export async function editPublicReview(req, res) {
    const actorId = requireUserId(req);
    const reviewId = requireParam(req, 'reviewId');
    const body = req.body;
...
export async function replyToPublicReview(req, res) {
    const actorId = requireUserId(req);
    const reviewId = requireParam(req, 'reviewId');
    const body = req.body;
...
export async function setPublicReviewVisibility(req, res) {
    const actorId = requireUserId(req);
    const reviewId = requireParam(req, 'reviewId');
    const body = req.body;
...
export async function deletePublicReview(req, res) {
    const actorId = requireUserId(req);
    const reviewId = requireParam(req, 'reviewId');
    const body = req.body;
