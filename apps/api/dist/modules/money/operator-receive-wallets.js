 ...
 */
import { isValidAddress } from './escrow-address.js';
/**
...
function keyOf(coin, network) {
    return `${coin}:${network}`;
}
/** Resolve the configured receive address for a coin/network (env overrides default). */
export function getOperatorReceiveAddress(coin, network) {
...
export function listOperatorReceiveWallets() {
...
//# sourceMappingURL=operator-receive-wallets.js.map