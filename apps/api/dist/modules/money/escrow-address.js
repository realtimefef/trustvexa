...
export function shortAddressPreview(address, lead = 6, tail = 4) {
...
export function canViewEscrowAddress(viewerUserId, deal) {
    return (viewerUserId === deal.buyerId ||
...
//# sourceMappingURL=escrow-address.js.map