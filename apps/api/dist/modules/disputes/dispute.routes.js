...
import { disputeIdParamSchema, openDisputeSchema, postMessageSchema, registerEvidenceSchema, resolveDisputeSchema, } from './dispute.schemas.js';
import * as controller from './dispute.controller.js';
const ACCOUNT_ROLES = ['user', 'middleman'];
export function disputeRouter() {
    const router = Router();
    ...
    router.get('/by-deal/:id', ...apiChain({ schemas: { params: dealIdParamSchema }, roles: [...ACCOUNT_ROLES] }), asyncHandler(controller.getByDeal));
    ...
    router.post('/by-deal/:id', ...apiChain({
    ...
    router.post('/by-deal/:id/resolve', ...apiChain({
    ...
    router.get('/:disputeId/messages', ...apiChain({ schemas: { params: disputeIdParamSchema }, roles: [...ACCOUNT_ROLES] }), asyncHandler(controller.listMessages));
    ...
    router.post('/:disputeId/messages', ...apiChain({
    ...
    router.post('/:disputeId/evidence', ...apiChain({
