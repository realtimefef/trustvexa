 ...
 */
export function inspectionWindowHours() {
    return envHours('INSPECTION_WINDOW_HOURS', 72);
}
export function fundingWindowHours() {
...
function sweepRequestId(kind, dealId, nowIso) {
...
async function tryTransition(dealId, event, kind, nowIso) {
    try {
...
export async function runLifecycleTimers(args = {}) {
...
export async function startFundingWindow(dealId, now = new Date()) {
...
export async function startCompletionClock(dealId, now = new Date()) {
...
export async function startInspectionWindow(dealId, now = new Date()) {
...
//# sourceMappingURL=lifecycle-timer.service.js.map