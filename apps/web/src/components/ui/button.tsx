...
// shadcn/ui Button primitive (scaffold baseline component).
  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]',
  {
    variants: {
      variant: {
        ...
        gradient:
          'bg-brand-gradient bg-[length:200%_auto] text-white shadow-glow hover:bg-[position:100%] hover:shadow-glow-lg',
        destructive: 'bg-destructive text-destructive-foreground hover:bg-destructive/90',
        outline:
          'border border-input bg-background/60 backdrop-blur hover:bg-accent/10 hover:text-foreground hover:border-primary/40',
      ...
      size: {
        ...
        xl: 'h-[3.25rem] rounded-xl px-9 text-base font-semibold [&_svg]:size-5',
        icon: 'h-10 w-10',
      },
    },
    defaultVariants: {
